...
**Why this happens:** "NumPy doesn't natively support bfloat16. The `ml_dtypes` package stores bfloat16 as uint16 with custom dtype metadata. When MLX reads this array, it sees the raw uint16 bit pattern and misinterprets it."
